...
// Query for last week
// Select * from rose where date >= curdate()-INTERVAL DAYOFWEEK(curdate())+6 DAY and date < curdate()-INTERVAL DAYOFWEEK(curdate())-1 DAY

//Query to return current week
//select floor((day('2020-01-07')-1)/7)+1 
//Select WEEK(CURRENT_DATE,0)+1
...
public class Graph extends javax.swing.JFrame {
    ...
    int currwk=0,clickwk=0,ct_wk=0,ct_mnth=0;
    String midstr="",endstr="";
    
   public Graph() {
       st=c.connection("montygreen");
        initComponents();
    ...
    private void initComponents() {
        ...
        combodata1.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        combodata2.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        comborange.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        comboduration.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        combopname.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rose", "Money" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(combodata1, 0, 165, Short.MAX_VALUE))))
    ...
    try
    {
        if(comborange.getSelectedItem().toString().equals("Week"))
        {
            ...
            rs=st.executeQuery("Select * from rose where WEEK(date)=WEEK(current_date)-"+(currwk-clickwk));            
        ...
        if(comborange.getSelectedItem().toString().equals("Month"))
        {
            ...
            for(i=1;i<(ct_wk+1);i++)
            {
                ...
                rs=st.executeQuery("Select * from rose where Date like '%-"+midstr+"-%' AND WEEK(date)=WEEK(current_date)-"+(currwk-i));            
                while(rs.next())
                {                    
        ...
        if(comborange.getSelectedItem().toString().equals("Year"))
        {
            ...
            for(i=1;i<13;i++)
            {
                if(i<10) rs=st.executeQuery("Select * from rose where Date like '"+comboduration.getSelectedItem().toString()+"-0"+i+"-%'");
                else rs=st.executeQuery("Select * from rose where Date like '"+comboduration.getSelectedItem().toString()+"-"+i+"-%'");            
       ...
       if(comborange.getSelectedItem().toString().equals("Month"))
       {
        ...
        try
        {
           for(int i=1;i<13;i++)
           {
                if(i<10) 
                {
                    rs=st.executeQuery("Select * from rose where Date like '2020-0"+i+"-%'");
                    if(rs.next())
                    {   ct_mnth++;
                        switch(i)
                        {
                ...
                {
                    rs=st.executeQuery("Select * from rose where Date like '2020-"+i+"-%'");
                    if(rs.next())
                    {   ct_mnth++;
                        switch(i)
                        {
